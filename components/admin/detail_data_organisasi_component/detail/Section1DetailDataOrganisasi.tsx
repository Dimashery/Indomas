...
interface Section1DetailDataOrganisasiProps {
  id: string;
}

const Section1DetailDataOrganisasi = ({
  id,
}: Section1DetailDataOrganisasiProps) => {
...
export default Section1DetailDataOrganisasi;